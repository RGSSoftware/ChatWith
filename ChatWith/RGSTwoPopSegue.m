...
#import "RGSTwoPopSegue.h"
#import "RGSBaseViewController.h"
#import "UIColor+RGSColorWithHexString.h"
@interface RGSTwoPopSegue ()
@property (nonatomic, weak)RGSBaseViewController *popToController;
@end

@implementation RGSTwoPopSegue
-(void)perform{
    ...
    //////////////////////
    [[[self sourceViewController] navigationController] popToViewController:[[[self sourceViewController] navigationController].viewControllers objectAtIndex:([[[self sourceViewController] navigationController].viewControllers count]- 3)] animated:NO];
